  ...
  render() {
    ...
    return (
      <div className={classes.todoInput}>
        <Input className={classes.input} onChange={this.handleChange} defaultValue={initialInput} />
        <Button onClick={this.handleClickAddTodo} variant="contained" color="primary">登録</Button>
        <Button className={classes.clearButton} onClick={this.handleClickClearTodo} variant="contained" color="secondary">クリア</Button>
      </div>
    );
  }
}
